  ...
  return (
    <footer className="container-bg dark:bg-slate-900 pt-6">
      <div className="mx-5 sm:flex sm:flex-row sm:justify-evenly">
        <div className="mb-9 mt-3 basis-1/4">
          ...
          <h3 className="text-sm font_merriweather dark:dark-secondary-text-col">
            Websites, Web apps and Mobile apps. Whatever you can imagine, we can
            bring to life !!
          </h3>
        </div>
        ...
        <div className="mb-10 sm:mb-5 basis-1/4">
          ...
          <li
            className="text-md ml-3 list-none font-normal italic hover:cursor-pointer mb-1 footer-link-transition dark:hover:dark-primary-text-col dark:dark-secondary-text-col"
            onClick={ScrollHomeDivIntoView}
          >
            Home
          </li>
          <li
            className="text-md ml-3 list-none font-normal italic hover:cursor-pointer mb-1 footer-link-transition dark:hover:dark-primary-text-col dark:dark-secondary-text-col"
            onClick={ScrollAboutDivIntoView}
          >
            About
          </li>
          <li
            className="text-md ml-3 list-none font-normal italic hover:cursor-pointer mb-1 footer-link-transition dark:hover:dark-primary-text-col dark:dark-secondary-text-col"
            onClick={ScrollEducationDivIntoView}
          >
            Education
          </li>
          <li
            className="text-md ml-3 list-none font-normal italic hover:cursor-pointer mb-1 footer-link-transition dark:hover:dark-primary-text-col dark:dark-secondary-text-col"
            onClick={ScrollSkillsDivIntoVIew}
          >
            Skills
          </li>
          <li
            className="text-md ml-3 list-none font-normal italic hover:cursor-pointer mb-1 footer-link-transition dark:hover:dark-primary-text-col dark:dark-secondary-text-col"
            onClick={ScrollServicesDivIntoVIew}
          >
            Services
          </li>
          <li
            className="text-md ml-3 list-none font-normal italic hover:cursor-pointer mb-1 footer-link-transition dark:hover:dark-primary-text-col dark:dark-secondary-text-col"
            onClick={ScrollProjectsDivIntoView}
          >
            Projects
          </li>
          <li
            className="text-md ml-3 list-none font-normal italic hover:cursor-pointer mb-1 footer-link-transition dark:hover:dark-primary-text-col dark:dark-secondary-text-col"
            onClick={ScrollCertificationsDivIntoView}
          >
            Certifications
          </li>
          <li
            className="text-md ml-3 list-none font-normal italic hover:cursor-pointer mb-1 footer-link-transition dark:hover:dark-primary-text-col dark:dark-secondary-text-col"
            onClick={ScrollContactDivIntoView}
          >
            Contact Me
          </li>
        </div>
        ...
        <div className="mb-5 basis-1/4">
          ...
          <li className="text-md ml-3 font-normal hover:cursor-pointer my-3 footer-link-transition dark:hover:dark-primary-text-col dark:dark-secondary-text-col flex flex-row">
            ...
            <span>larryking8118@gmail.com</span>
          </li>

          <Link to="https://github.com/larryking01" target="_blank">
            <li className="text-md ml-3 font-normal hover:cursor-pointer my-3 footer-link-transition dark:hover:dark-primary-text-col dark:dark-secondary-text-col flex flex-row">
              <AiOutlineGithub size={20} className="mr-2" />{' '}
              <span>github.com/larryking01</span>
            </li>
          </Link>

          <Link
            to="https://www.linkedin.com/in/larry-williams8118"
            target="_blank"
          >
            <li className="text-md ml-3 font-normal hover:cursor-pointer my-3 footer-link-transition dark:hover:dark-primary-text-col dark:dark-secondary-text-col flex flex-row">
              <AiOutlineLinkedin size={23} className="mr-2" />{' '}
              <span>linkedin.com/in/larry-williams8118</span>
            </li>
          </Link>
        </div>
      </div>
      ...
      <div className="ml-5 py-4 secondary-col sm:text-center">
        <h3 className="font_poppins text-sm sm:text-md dark:dark-secondary-text-col">
