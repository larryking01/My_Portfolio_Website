...
import {
  CertificationItem,
  certificationsArray,
} from '../data/certificationsSectionHandler';
    ...
    if (contactMeUserEmail.length === 0) {
      ...
      if (!contactMeUserEmail.match(regex)) {
        setUserContactMeError(
          'Invalid email...Provide a valid email to continue'
        );
      } else {
        ...
        <div>
            ...
            <div className="my-1 sm:mx-16 md:mx-20 text-center sm:flex sm:flex-row sm:justify-evenly">
              <div
                className={
                  expanded === true
                    ? 'remove-cover-pic'
                    : 'px-1 mx-4 md:mx-0 md:py-10 md:rounded-none rounded-full basis-1/4 sm:py-16 sm:w-full sm:h-64'
                }
              >
                <img
              ...
              <div className="pt-2 md:pt-36 basis-3/4">
                <div>
                  <span
                    ref={name_ref}
                    className="text-xl font-bold mt-1 ml-3 text-center secondary-col sm:text-5xl font-playfair dark:dark-primary-text-col"
                  ></span>
                </div>
                ...
                <div className="mt-1 sm:mt-4 md:container-y-margins">
                  <span
                    ref={job_title_ref}
                    className="text-md italic text-center mt-3 md:ml-5 sm:ml-12 sm:mt-5 font-merriweather font-semibold sm:text-lg dark:dark-primary-text-col"
                  ></span>
                </div>
          ...
          >
            <div>
              ...
              >
                My Tech Journey: Passion, Purpose, and Progress
              </h2>
            </div>
          ...
          >
            <div>
              <h2
                ...
                data-aos-duration={parent_timer}
              >
                Professional Journey: My Experience
              </h2>
            </div>
          ...
          <div className="container-y-margins">
            <div className="container-x-margins mb-4 sm:mx-28" ref={skills_ref}>
              <h2
                ...
                data-aos-duration={parent_timer}
              >
                My Development Arsenal: Skills & Technologies
              </h2>
              <p className="text-sm md:text-base font_poppins dark:dark-secondary-text-col">
                I've spent countless hours mastering these technologies, and I
                continue to stay on the cutting edge to ensure I can deliver the
                best possible results.
              </p>
            </div>

            <div
              className="grid grid-cols-2 mx-3 gap-3 hover:cursor-pointer
                                sm:mx-28 sm:grid-cols-4 "
            >
              {skillsArray.map((skill: SkillItem) => (
                <div
                  className="my-1 p-3 text-center container-bg rounded-lg transition-all 
                                        duration-1000 hover:shadow-lg hover:bg-slate-300 dark:dark-card-bg-col"
                  data-aos={child_animation}
                  data-aos-duration={child_timer}
                >
          ...
          >
            ...
            <p className="text-sm md:text-base font_poppins dark:dark-secondary-text-col">
              Dive in and explore the real-world applications of my skills, and
              see how I bring concepts to life through code.
            </p>
            <div className="sm:grid sm:grid-flow-row sm:grid-cols-3 sm:gap-5">
              {projectsArray.map((project: ProjectItem) => {
                return (
                  <div
                    className="container-bg my-4 pb-3 shadow-lg transition-all duration-500 
                    ...
                    <div className="p-2">
                      ...
                      <Link to={project.projectLink} target="_blank">
                        <div className="flex justify-center">
                          <button
                            className="bg-[#ec5b53] transition-all duration-200 hover:bg-[#c73a32] 
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-2">
                      ...
                      <h3 className="text-sm text-center font_poppins mx-1 mb-2">
                        {certification.course_description}
                      </h3>
                    </div>
                  </div>
                );
          ...
          >
            ...
            <p className="text-sm md:text-base font_poppins dark:dark-secondary-text-col">
              Discover the range of professional services I offer, designed to
            ...
            <div className="sm:grid sm:grid-flow-row sm:grid-cols-3 sm:gap-5">
              {servicesArray.map((service: ServiceItem) => {
                return (
                  <div
                    className="container-bg border-0 rounded-lg shadow-lg pt-2 pb-8 text-center mb-4 
          ...
          >
            ...
            <p
              className="text-sm md:text-base font_poppins mb-3 mt-2 text-md dark:dark-secondary-text-col" /*data-aos={ child_animation } data-aos-duration={ child_timer }*/
            >
              I'm excited to connect with you and discuss potential job
              opportunities, collaborations, or any questions you may have.
            </p>
            ...
            <div className="sm:grid sm:grid-flow-row sm:grid-cols-3 sm:gap-5 ">
              {contactMeArray.map((contact_me: ContactMeItem) => {
                return (
                  <div
                    className="container-bg my-4 shadow-lg py-12 transition-all duration-200 rounded-lg hover:bg-slate-300 dark:rounded-lg dark:dark-card-bg-col"
                    data-aos={child_animation}
                    data-aos-duration={child_timer}
                  >
                    <div className="flex items-center justify-center">
          ...
          >
            ...
            <p className="text-sm md:text-base font_poppins dark:dark-secondary-text-col mb-5">
              Get in touch with me and let us bring your wonderful ideas into
              life!
            </p>
            ...
            <Form onSubmit={HandleUserContactMeSubmit}>
              ...
              <button
                type="submit"
                className="bg-[#ec5b53] transition-all duration-200 
